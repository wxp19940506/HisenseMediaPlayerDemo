...
package com.example.xiaopengwang.mediaplayerdemo.helper;
...
/**
 * HisensePlayerInterface is used to collect and monitor data from the video played on assigned MediaPlayer instance and reports the data to Conviva Android SDK.
 ...
 */
public class HisenseMediaPlayerInterface implements MediaPlayer.OnErrorListener,
     ...
     */
    public HisenseMediaPlayerInterface(PlayerStateManager playerStateManager, MediaPlayer player) {
...
//        Log("OnError : Error occurred", SystemSettings.LogLevel.DEBUG);
    ...
    public boolean onInfo(MediaPlayer mp, int what, int extra) {
        Log.e("info","what:"+what+"extra:"+extra);
