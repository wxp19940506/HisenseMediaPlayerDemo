...
public class ConvivaSessionManager {
    ...
    public static void createConvivaSession(String mediaUrl) {
        ...
        try {
            ...
            convivaMetaData.assetName = "test video";
...
//                    mClient.sendCustomEvent(mSessionKey, "Conviva.PodStart", attributes);
                    mClient.sendCustomEvent(Client.NO_SESSION_KEY, "Conviva.PodStart", attributes);
                    break;

                case POD_END:
//                    mClient.sendCustomEvent(mSessionKey, "Conviva.PodEnd", attributes);
                    mClient.sendCustomEvent(Client.NO_SESSION_KEY, "Conviva.PodEnd", attributes);
                    break;
                default:
                    break;
            }
