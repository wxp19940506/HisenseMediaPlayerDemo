...
import com.example.xiaopengwang.mediaplayerdemo.helper.HisenseMediaPlayerInterface;
...
public class PlayerActivity extends Activity implements SurfaceHolder.Callback, MediaPlayer.OnPreparedListener, MediaPlayer.OnInfoListener,
    ...
    HisenseMediaPlayerInterface mPlayerInterface;
    ...
    private void releasePlayer() {
        if (mPlayer != null) {
            // 因为媒体播放器将被释放,所有相关的PlayerStateManager和analyticsInterface也应该被释放
            releaseAnalytics();
        }
    }
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        // 3：player与session绑定，正常讲这个Interface文件由我们提供，也可以开发者自己写
        mPlayerInterface = new HisenseMediaPlayerInterface(mStateManager, mPlayer);
